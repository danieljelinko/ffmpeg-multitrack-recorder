...
## In flight
- **Phase 1 complete (pinned `stable-10590`).** Holding at checkpoint for go-ahead on **Phase 1B** (latest-version re-validation).

## Next
- Phase 1B: bump to latest Jitsi + deps, re-validate, log compatibility ceiling.
- Phase 2: Zulip → our Jitsi call-manager, record a Zulip-started call.
